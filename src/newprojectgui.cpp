    ...
    QWidget(0),controller(aController)
{
    ...
    nameEdit->setStyleSheet("background:2x solid #3a3a3a;border-radius:3px;");
    nameEdit->setMinimumHeight(30);
    nameEdit->setMinimumWidth(400);
    error = new QLabel();
    videoButton = new QPushButton("Parcourir");
    this->videoButton->setStyleSheet("background:#3a3a3a;border-radius:3px;padding:5%;color:white;");
    ...
    selectFramerate->setMinimumHeight(30);
    selectFramerate->setStyleSheet("background:#3a3a3a;border-radius:3px;border:none;");
    ...
    videoEdit->setStyleSheet("background:2x solid #3a3a3a;border-radius:3px;");
    videoEdit->setMinimumHeight(30);
    createButton = new QPushButton("Création de Projet");
    this->createButton->setMinimumSize(100,30);
    this->createButton->setStyleSheet("background:#3a3a3a;border-radius:3px;padding:5%;color:white;");
